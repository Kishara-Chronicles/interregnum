...
# Notlar
- [ ] Rütbesi: Onbaşı
- [ ] Baharda (19 mayıs?) doğmuş ancak kış dönümünde, 21 aralık, doğduğunu söylüyor
- [ ] [[Harald'ın Günlüğü]]
- [ ] Memleket : Lupea
- [ ] Hortlak rününü kullandı  [[IR47 - Gym Fight]]'ta.
# Bekliyor
- [ ] [[Mareşal Franz]] hakkında 1 key knowsledege - sonrasında ortaya çıkacak
...
Whenever you roll initiative, you gain a tactics die, which is a d4. While you have this die, any creature friendly to you within 60 feet of you that can hear or see you can roll the tactics die as a bonus die when [making an attack roll](https://a5e.tools/rules/making-attack "Click to view a local node.") . Once rolled, the tactics die is lost until you regain it at the start of your next turn. The tactics die disappears when the combat ends.
...
Commanding Presence which extends from you in a **20-foot radius.** 
...
**Expertise** zarı ekliyor diğer kişilere.
...
## Call to Arms
When you roll initiative, you and each creature friendly to you that are within range of your Commanding Presence **gain an expertise die to their initiative check.** Additionally, when you roll for initiative, **you can switch your result with that of any ally you can see.**
...
At 7th level, choose either Culture, History, or Nature. You gain proficiency with the chosen skill and an [expertise die](https://a5e.tools/node/77 "Click to view a local node.") on checks made using the chosen skill.

* Culture as a new proficiency but expertise die on the **history**. 
# Combat Maneuvers
...
When you activate this maneuver, you take the Attack action and make a melee weapon attack, as well as any additional attacks granted by Extra Attack. Until the start of your next turn, when you hit with a melee weapon attack against a creature and deal 8 or more damage it makes a Dexterity saving throw or is knocked prone. Furthermore, the target must succeed on a Strength or Dexterity Saving Throw against your maneuver DC before they can stop being prone."

* Kalkmak için de save atıyor bu
## Wounding Strike
...
Choose a weapon when you learn this combat maneuver. If you hit with your next [attack roll](https://www.a5e.tools/rules/making-attack "Click to view a local node.") using the chosen weapon against a living creature, you deliver a wound that deals 1d4 ongoing damage. 

At the start of each of the wounded creature's turns, it makes a Constitution [saving throw](https://www.a5e.tools/rules/saving-throw "Click to view a local node.") , ending the effect on itself on a success. 
...
In addition, each of you gets an extra reaction that can be used before the start of your next turn to either make an [opportunity attack](https://www.a5e.tools/rules/making-attack "Click to view a local node.") or activate a combat maneuver.
...
Weapon, Uncommon (cost 400 gp) [Cursed](https://a5e.tools/magic-item-tags/cursed)
...
# The Sword of 3 Traditions
Weapon, Artifact (requires attunement)

Taşlar: Opal, Elmas, Zümrüt
...
The Sword of Three Traditions is a **+1 longsword** . Once you are attuned, you can use an action to turn the sword into a different +1 weapon. In addition, when you use a combat maneuver, the sword can automatically change into the weapon associated with that tradition. To change into a given weapon, the gem associated with that tradition must be attached.

The weapons the sword can currently transform into are:
**Mirror's Glint:** Saber and light shield
**Razor's Edge:** Longsword
**Unending Wheel**: Rapier
...
Each of the lost magical gemstones of the Sword of Three Traditions is a wondrous item and artifact that requires attunement. You can only attune to the magical gemstone separately if you know a combat maneuver from the tradition associated with it. When you attune to a gemstone separately, it increases the DC of your combat maneuvers of a tradition associated with the attached gem by 1.
...
The sword is currently affixed with its opal, emerald, and diamond (for the Mirror's Glint, Unending Wheel, and Razor’s Edge traditions). 

Artifact Properties

The Sword of Three Traditions currently has one lesser artifact benefit. When 7 gems are in its pommel, it will gain another lesser artifact benefit. When fully restored with all 11 magical gemstones, it will gain 1 greater artifact benefit.

War Leader. The wielder of the sword can take an action to magically cause their voice or signal to carry clearly for up to 600 feet until the end of their next turn.
